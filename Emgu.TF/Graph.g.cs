...
//  This code is automatically generated by a program from Tensorflow 1.10.0.  
...
namespace Emgu.TF
{
   public partial class Graph : UnmanagedObject
   {
      ...
      ///</summary>
      ///<param name="data">Input to the operation: An int16 tensor.</param>
      ...
      ///<param name="class_id">Input to the operation: A scalar, the class id for which we're building the splits.</param>
      ///<param name="feature_column_group_id">Input to the operation: A scalar, the index of the feature we are spiltting on.</param>
      ///<param name="bias_feature_id">Input to the operation. </param>
      ///<param name="l1_regularization">Input to the operation: A scalar, which specifies the l1 regularization term.</param>
      ///<param name="l2_regularization">Input to the operation: A scalar, which specifies the l2 regularization term.</param>
      ///<param name="tree_complexity_regularization">Input to the operation: A scalar, which specifies the tree complexity regularization term.</param>
      ///<param name="min_node_weight">Input to the operation: A scalar, minimum sum of example hessian needed in a child. If a split results in a leaf node with a smaller value, the split will not be considered.</param>
      ///<param name="multiclass_strategy">Input to the operation: A scalar, specifying the multiclass handling strategy. See LearnerConfig.MultiClassStrategy for valid values.</param>
      ///<param name="opName">The name of the operation</param>
      ///<return>
      ...
      ///</return>
      public Operation BuildCategoricalEqualitySplits (  Output num_minibatches , Output partition_ids , Output feature_ids , Output gradients , Output hessians , Output class_id , Output feature_column_group_id , Output bias_feature_id , Output l1_regularization , Output l2_regularization , Output tree_complexity_regularization , Output min_node_weight , Output multiclass_strategy ,String opName= "BuildCategoricalEqualitySplits" ) 
      {
         ...
         desc.AddInput(feature_column_group_id);
         desc.AddInput(bias_feature_id);
         desc.AddInput(l1_regularization);
         desc.AddInput(l2_regularization);
         desc.AddInput(tree_complexity_regularization);
         desc.AddInput(min_node_weight);
         desc.AddInput(multiclass_strategy);
      ...
      ///</return>
      //The following attributes are not known: f: func
      public Operation FunctionBufferingResource (  Output string_arg , Output target_device , string shared_name, string container, long buffer_size, DataType[] output_types,String opName= "FunctionBufferingResource" ) 
      {
      ...
      ///<param name="factor_weights">Input to the operation: Vector of size m. Corresponds to column weights. Should be empty if entry_weights is used.</param>
      ///<param name="unobserved_weights">Input to the operation: Scalar. Weight for unobserved input entries.</param>
      ///<param name="input_weights">Input to the operation: Vector of size n. Corresponds to row weights. Should be empty if entry_weights is used.</param>
      ...
      ///<param name="entry_weights">Input to the operation: If not empty, this must be same length as input_vaues and is used as the per-entry non-zero weight. If this is used, input_weights and factor_weights must be empty.</param>
      ...
      ///</return>
      public Operation WALSComputePartialLhsAndRhs (  Output factors , Output factor_weights , Output unobserved_weights , Output input_weights , Output input_indices , Output input_values , Output entry_weights , Output input_block_size , Output input_is_transpose ,String opName= "WALSComputePartialLhsAndRhs" ) 
      {
      ...
      ///<return>
      ///[0] predictions(type: DtFloat): Rank 2 Tensor containing predictions per example per class.
      ///[1] drop_out_tree_indices_weights(type: DtFloat): Tensor of Rank 2 containing dropped trees indices
      ///[2] leaf_index(type: DtInt32): tensor of rank 2 containing leaf ids for each tree where an instance ended up.
      ///</return>
      public Operation GradientTreesPredictionVerbose (  Output tree_ensemble_handle , Output seed , Output dense_float_features , Output sparse_float_feature_indices , Output sparse_float_feature_values , Output sparse_float_feature_shapes , Output sparse_int_feature_indices , Output sparse_int_feature_values , Output sparse_int_feature_shapes , string learner_config, bool apply_dropout, bool apply_averaging, bool center_bias, bool reduce_dim, bool use_locking = false ,String opName= "GradientTreesPredictionVerbose" ) 
      {
         OperationDescription desc = NewOperation("GradientTreesPredictionVerbose", opName);
         desc.AddInput(tree_ensemble_handle);
         desc.AddInput(seed);
         desc.AddInput(dense_float_features);
         desc.AddInput(sparse_float_feature_indices);
      ...
      ///</summary>
      ///<param name="selector_input_dataset">Input to the operation: A dataset of scalar `DT_INT64` elements that determines which of the `N` data inputs should produce the next output element.</param>
      ///<param name="data_input_datasets">Input to the operation: `N` datasets with the same type that will be interleaved according to the values of `selector_input_dataset`.</param>
      ///<param name="output_types"></param>
      ///<param name="output_shapes"></param>
      ///<param name="opName">The name of the operation</param>
      ///<return>
      ...
      ///</summary>
      ///<param name="pmf">Input to the operation. </param>
      ///<param name="precision"></param>
      ///<param name="opName">The name of the operation</param>
      ///<return>
      ///[0] cdf(type: DtInt32).
      ///</return>
      public Operation PmfToQuantizedCdf (  Output pmf , long precision,String opName= "PmfToQuantizedCdf" ) 
      {
         OperationDescription desc = NewOperation("PmfToQuantizedCdf", opName);
         desc.AddInput(pmf);
         desc.SetAttr("precision", precision);
      ...
      ///[2] split_infos(type: DtString): A rank 1 tensor of serialized protos which contains the `SplitInfo`s.
      ///</return>
      public Operation BuildDenseInequalitySplits (  Output num_minibatches , Output partition_ids , Output bucket_ids , Output gradients , Output hessians , Output bucket_boundaries , Output class_id , Output feature_column_group_id , Output l1_regularization , Output l2_regularization , Output tree_complexity_regularization , Output min_node_weight , Output multiclass_strategy ,String opName= "BuildDenseInequalitySplits" ) 
      {
      ...
      ///[2] split_infos(type: DtString): A rank 1 tensor of serialized protos which contains the `SplitInfo`s.
      ///</return>
      public Operation BuildSparseInequalitySplits (  Output num_minibatches , Output partition_ids , Output bucket_ids , Output gradients , Output hessians , Output bucket_boundaries , Output class_id , Output feature_column_group_id , Output bias_feature_id , Output l1_regularization , Output l2_regularization , Output tree_complexity_regularization , Output min_node_weight , Output multiclass_strategy ,String opName= "BuildSparseInequalitySplits" ) 
      {
      ...
      ///<param name="opName">The name of the operation</param>
      public Operation FunctionBufferingResourceReset (  Output function_buffer_resource ,String opName= "FunctionBufferingResourceReset" ) 
      {
         OperationDescription desc = NewOperation("FunctionBufferingResourceReset", opName);
      ...
      ///[0] handle(type: DtVariant).
      ///</return>
      public Operation FeatureStatsDataset (  Output input_dataset , Output tag , DataType[] output_types, long[][] output_shapes,String opName= "FeatureStatsDataset" ) 
      {
         OperationDescription desc = NewOperation("FeatureStatsDataset", opName);
         desc.AddInput(input_dataset);
         desc.AddInput(tag);
         desc.SetAttr("output_types", output_types);
         desc.SetAttrShapeList("output_shapes", output_shapes);
      ...
      ///<param name="opName">The name of the operation</param>
      ///<return>
      ///[0] decoded(type: DtInt16): An int16 tensor with shape equal to `shape`.
      ///</return>
      ...
      ///[0] handle(type: DtVariant).
      ///</return>
      public Operation CSVDataset (  Output filenames , Output buffer_size , Output header , Output field_delim , Output use_quote_delim , Output na_value , Output select_cols , Output record_defaults , long[][] output_shapes,String opName= "CSVDataset" ) 
      {
      ...
      ///<param name="max_intra_op_parallelism">The maximum degree of parallelism to use within operations that execute on this threadpool.</param>
      ///<param name="container"></param>
      ///<param name="shared_name"></param>
      ///<param name="opName">The name of the operation</param>
      ///<return>
      ...
      public Operation ThreadPoolHandle (  long num_threads, string display_name, long max_intra_op_parallelism = 1 , string container = null , string shared_name = null ,String opName= "ThreadPoolHandle" ) 
      {
         ...
         if (max_intra_op_parallelism != 1) desc.SetAttr("max_intra_op_parallelism", max_intra_op_parallelism);
         if (container != null) desc.SetAttr("container", container);
         if (shared_name != null) desc.SetAttr("shared_name", shared_name);
         return desc.FinishOperation();
      } 
      ...
      ///</summary>
      ///<param name="var">Input to the operation: Should be a ResourceVariable.</param>
      ///<param name="dtype"></param>
      ///<param name="shape"></param>
      ///<param name="opName">The name of the operation</param>
      ///<return>
      ///[0] output_var(type: DtResource): = Same as "var".
      ///</return>
      public Operation ZeroVarInitializer (  Output var , DataType dtype, long[] shape,String opName= "ZeroVarInitializer" ) 
      {
         OperationDescription desc = NewOperation("ZeroVarInitializer", opName);
         desc.AddInput(var);
         desc.SetAttr("dtype", dtype);
      ...
      ///[1] col_to_row_match_indices(type: DtInt32): A vector of length num_columns, which is the number of columns of the input distance matrix. If `col_to_row_match_indices[j]` is not -1, column j is matched to row `col_to_row_match_indices[j]`.
      ///</return>
      ...
      ///<param name="opName">The name of the operation</param>
      ///<return>
      ///[0] image(type: DtUint8): = A tensor of size 'output_image_shape' with the encoded 'depth_values'
      ///</return>
      ...
      ///<param name="group_assignment">The list of group ids. `group_assignment[i]` represents the group id of replica i.</param>
      ///<param name="opName">The name of the operation</param>
      ///<return>
      ///[0] output(type: DtInvalid): The sum of all the distributed inputs.
      ///</return>
      public Operation CrossReplicaSum (  Output input , long[] group_assignment = null ,String opName= "CrossReplicaSum" ) 
      {
         OperationDescription desc = NewOperation("CrossReplicaSum", opName);
         desc.AddInput(input);

         if (group_assignment != null) desc.SetAttr("group_assignment", group_assignment);
         return desc.FinishOperation();
      } 
      ...
      ///<param name="use_tpu"></param>
      ///<param name="device_assignment"></param>
      ///<param name="computation_shape"></param>
      ///<param name="host_compute_core"></param>
      ///<param name="opName">The name of the operation</param>
      public Operation TPUReplicateMetadata (  long num_replicas, string topology = null , bool use_tpu = true , long[] device_assignment = null , long[] computation_shape = null , string[] host_compute_core = null ,String opName= "TPUReplicateMetadata" ) 
      {
         ...
         if (use_tpu != true) desc.SetAttr("use_tpu", use_tpu);
      ...
      ///<param name="use_tpu">a bool indicating if this computation will run on TPU or CPU/GPU. Currently, only supports a default placement (computation is placed on GPU if one is available, and on CPU if not).</param>
      ...
      public Operation TPUReplicate (  Output inputs , Output broadcast_inputs , Output variables , Output guaranteed_constants , long num_replicas, DataType[] output_types, string topology = null , bool use_tpu = true , long[] device_assignment = null , string[] host_compute_core = null , long[] computation_shape = null ,String opName= "TPUReplicate" ) 
      {
