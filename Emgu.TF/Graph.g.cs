...
namespace Emgu.TF
{
   public partial class Graph : UnmanagedObject
   {
      ...
      public Operation ParallelMapDataset (  Output input_dataset , Output other_arguments , Output num_parallel_calls , DataType[] output_types, long[][] output_shapes, bool use_inter_op_parallelism = true , String opName= "ParallelMapDataset" ) 
      {
         ...
         desc.SetAttr("output_types", output_types);
         desc.SetAttrShapeList("output_shapes", output_shapes);
         if (use_inter_op_parallelism != true) desc.SetAttr("use_inter_op_parallelism", use_inter_op_parallelism);
         return desc.FinishOperation();
      } 
      ...
      public Operation ConditionalAccumulator (  DataType dtype, long[] shape, string container = null , string shared_name = null , string reduction_type = null , String opName= "ConditionalAccumulator" ) 
      {
         ...
         if (container != null) desc.SetAttr("container", container);
         if (shared_name != null) desc.SetAttr("shared_name", shared_name);
         if (reduction_type != null) desc.SetAttr("reduction_type", reduction_type);
         return desc.FinishOperation();
      } 
      ...
      public Operation StringFormat (  Output inputs , string template = null , string placeholder = null , long summarize = 3 , String opName= "StringFormat" ) 
      {
         ...
         if (template != null) desc.SetAttr("template", template);
         if (placeholder != null) desc.SetAttr("placeholder", placeholder);
      ...
      public Operation PrintV2 (  Output input , string output_stream = null , String opName= "PrintV2" ) 
      {
         ...
         if (output_stream != null) desc.SetAttr("output_stream", output_stream);
         return desc.FinishOperation();
      } 
      ...
      public Operation StringLength (  Output input , string unit = null , String opName= "StringLength" ) 
      {
         ...
         if (unit != null) desc.SetAttr("unit", unit);
         return desc.FinishOperation();
      } 
