...
//  This code is automatically generated by a program from Tensorflow 1.6.0.  
...
namespace Emgu.TF
{
   public partial class Graph : UnmanagedObject
   {
      ...
      ///[0] resource(type: DtResource).
      ///</return>
      public Operation CriticalSectionOp (  string container = null , string shared_name = null ,String opName= "CriticalSectionOp" ) 
      {
         OperationDescription desc = NewOperation("CriticalSectionOp", opName);
      ...
      ///</return>
      public Operation ConfigureDistributedTPU (  string embedding_config = null , string tpu_embedding_config = null ,String opName= "ConfigureDistributedTPU" ) 
      {
      ...
      ///[2] id(type: DtInt64).
      ///</return>
      public Operation Batch (  Output in_tensors , long num_batch_threads, long max_batch_size, long batch_timeout_micros, long grad_timeout_micros, long[] allowed_batch_sizes = null , string container = null , string shared_name = null , string batching_queue = null ,String opName= "Batch" ) 
      {
      ...
      ///
      ///</summary>
      ///<param name="critical_section">Input to the operation. </param>
      ...
      ///</return>
      //The following attributes are not known: f: func
      public Operation ExecuteInCriticalSection (  Output critical_section , Output arguments , DataType[] output_types, long[][] output_shapes,String opName= "ExecuteInCriticalSection" ) 
      {
         OperationDescription desc = NewOperation("ExecuteInCriticalSection", opName);
         desc.AddInput(critical_section);
