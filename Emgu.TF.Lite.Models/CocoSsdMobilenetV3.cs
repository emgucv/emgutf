...
{
    public class CocoSsdMobilenetV3 : Emgu.TF.Util.UnmanagedObject
    {
                ...
                String localModelFolder = "CocoSsdMobilenetV3")
        {
            ...
            String url = downloadUrl == null ? "https://github.com/emgucv/models/raw/master/coco_ssd_mobilenet_v3_small_2010_01_14/" : downloadUrl;
            String[] fileNames = modelFiles == null ? new string[] { "model.tflite", "labelmap.txt" } : modelFiles;
